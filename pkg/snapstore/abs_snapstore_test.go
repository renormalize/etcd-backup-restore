...
func (c *fakeABSContainerClient) setTag(taggedSnapshotName string, tagMap map[string]string) {
	c.objectTags[taggedSnapshotName] = map[string]string{"x-etcd-snapshot-exclude": "true"}
}

func (c *fakeABSContainerClient) deleteTag(taggedSnapshotName string) {
